...
CREATE TABLE alumni_profiles (
    ...
    nisn          VARCHAR(255) NOT NULL UNIQUE COMMENT 'Nomor Induk Siswa Nasional',
    full_name     VARCHAR(255) NOT NULL,
    gender        ENUM('male','female') NOT NULL,
    birth_date    DATE NULL,
    phone         VARCHAR(255) NULL,
    address       TEXT NULL,
    jurusan       VARCHAR(255) NOT NULL COMMENT 'Program keahlian/jurusan',
    graduation_year YEAR NOT NULL,
    work_status   ENUM('unemployed','employed','entrepreneur','continuing_edu') NOT NULL DEFAULT 'unemployed',
    cv_path       VARCHAR(255) NULL COMMENT 'Path ke file CV (PDF)',
...
CREATE TABLE job_vacancies (
    ...
    jurusan_required VARCHAR(255) NULL COMMENT 'Jurusan yang diprioritaskan, NULL = semua',
